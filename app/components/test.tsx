...
const tiles = [
  {
    icon: <MapPinIcon className="size-full" />, // Analytics
    bg: (
  ...
  {
    icon: <TruckIcon className="size-full" />, // User Journeys
    bg: (
  ...
  {
    icon: <ShipIcon className="size-full" />, // Data Visualization
    bg: (
  ...
  {
    icon: <CheckCircle className="size-full" />, // Integrations
    bg: (
  ...
  {
    icon: <BoxIcon className="size-full" />, // Additional service
    bg: (
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-1/2 w-1/2 -translate-x-1/2 -translate-y-1/2 overflow-visible rounded-full bg-gradient-to-r from-orange-600 via-rose-600 to-violet-600 opacity-70 blur-[20px] filter"></div>
    ),
  },
      ...
      <div className="py-14">
        <div className="flex w-full flex-col items-center justify-center">
          <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
            ...
            <div className="absolute z-10  bg-white/10 p-3 shadow-2xl backdrop-blur-md">
              <div className="mx-auto size-24 rounded-[2rem] border bg-white/10 p-3 shadow-2xl backdrop-blur-md dark:bg-black/10 lg:size-32">
                <MapPinIcon className="mx-auto size-16 text-black dark:text-white lg:size-24" />
              </div>
