export const SocialMedia = () => {
  return (
    <div className=" mx-auto  max-w-7xl rounded-lg bg-gray-50 p-10 px-6 lg:px-8 ">
      ...
      <div className=" z-20 mt-10  items-center justify-center space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
        <a
          ...
          target="_blank"
          className="bg-white inline-flex w-full items-center justify-center rounded-lg border px-4 py-2.5 text-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 sm:w-auto "
        >
          <svg
            stroke="currentColor"
            fill="currentColor"
        ...
        <a
          ...
          target="_blank"
          className="inline-flex bg-white w-full items-center justify-center rounded-lg border bg-gray-50 px-4 py-2.5 text-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 sm:w-auto "
        >
          <svg
            stroke="currentColor"
            fill="currentColor"
